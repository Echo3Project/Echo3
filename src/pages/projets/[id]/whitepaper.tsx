            ...
            <div className="w-full flex justify-center">
                <div className="relative w-full flex flex-col items-center">
                    <div
                        ...
                        />
                        <button className="absolute top-14 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-black text-xs text-center uppercase font-jwsans font-medium">
                            <div className="absolute top-0 left-0 w-1 h-1 bg-black rounded-full" />
                                ...
                                <div className="flex gap-4">
                                    <div className="flex gap-1 items-center">
                                        ...
                                        <span className="font-jwsans font-medium text-gray-400">
                                            {formatNumberWithK(project.discord)}
                                        </span>
                                    </div>
                                    <div className="flex gap-1 items-center">
                                        <div
                                        ...
                                        />
                                        <span className="font-jwsans font-medium text-gray-400">
                                            {formatNumberWithK(project.twitter)}
                                        </span>
                                    </div>
                                </div>
                                <Link
                            ...
                            <div>
                                <div className="flex gap-1 mt-6">
                                    <button
                                        ...
                                        style={{
                                            backgroundImage: allFilterIsActive
                                        ...
                                        onClick={(): void => handleAllClick()}>
                                        Tout
                                    </button>
                                    <button
                                        className="font-jwsans font-bold text-xs"
                                        style={{
                                            backgroundImage: videoFilterIsActive
